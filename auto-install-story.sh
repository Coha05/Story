...
# Step 4: Download and Install Story Binary (v0.9.13)
echo "Downloading and installing Story binary (v0.9.13)..."
...
cp /tmp/story-linux-amd64-0.9.13-b4c7db1/story $HOME/go/bin/story
